...
private:
    ...
    void loadModel(string path)
    {
        ...
        // Details on the different flags to use are available at: https://the-asset-importer-lib-documentation.readthedocs.io/en/latest/usage/postprocessing.html
